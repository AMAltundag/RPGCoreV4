package me.blutkrone.rpgcore.nms.v1_19_R1.menu;
...
public class VolatileTextInput implements ITextInput {
    ...
    public void open() {
        ...
        nmsPlayer.b.a(new PacketPlayOutOpenWindow(this.nms_anvil.j, Containers.h, IChatBaseComponent.b("opened without a title!")));
        nmsPlayer.bU = this.nms_anvil;
    ...
    public void setTitle(BaseComponent[] title) {
        Bukkit.getScheduler().runTask(this.plugin, () -> {
            ...
            Container active_container = ((CraftPlayer) player).getHandle().bU;
    ...
    public class NMSAnvil extends ContainerAnvil {
        ...
        NMSAnvil(EntityPlayer player, int containerId) {
            super(containerId, player.fA(), ContainerAccess.a(player.s, new BlockPosition(0, 0, 0)));
