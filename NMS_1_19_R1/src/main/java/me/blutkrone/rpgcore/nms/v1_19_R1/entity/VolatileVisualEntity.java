...
public class VolatileVisualEntity extends EntityArmorStand implements IEntityVisual {
    ...
    public ItemStack getItem(EquipmentSlot slot) {
        if (slot == EquipmentSlot.HAND) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.a));
        } else if (slot == EquipmentSlot.OFF_HAND) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.b));
        } else if (slot == EquipmentSlot.FEET) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.c));
        } else if (slot == EquipmentSlot.LEGS) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.d));
        } else if (slot == EquipmentSlot.CHEST) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.e));
        } else if (slot == EquipmentSlot.HEAD) {
            return CraftItemStack.asBukkitCopy(super.c(EnumItemSlot.f));
        } else {
    ...
    public Vector getLocation() {
        return new Vector(super.df(), super.dh(), super.dl());
    }

    @Override
    public org.bukkit.entity.Entity getRiding() {
        Entity vehicle = super.cQ();
        if (vehicle == null) {
            return null;
        }
    ...
    public boolean isActive() {
        return Bukkit.getEntity(super.co()) != null;
    }
