package me.blutkrone.rpgcore.nms.v1_20_R1.menu;
...
public class VolatileChestMenu extends CraftInventoryCustom implements IChestMenu {
    ...
    public void setTitle(BaseComponent[] title) {
        ...
        Bukkit.getScheduler().runTask(this.plugin, () -> {
            ...
            MenuType<?> container = active_container.getType();
            // process the update call we expected
            ClientboundOpenScreenPacket packet = new ClientboundOpenScreenPacket(window_id, container, component);
