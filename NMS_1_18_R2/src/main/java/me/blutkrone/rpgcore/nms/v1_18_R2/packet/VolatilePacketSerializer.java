...
/*
 * A wrapper around the NMS packet data serializer, surface level
 * methods should ease obfuscation.
 */
public class VolatilePacketSerializer extends PacketDataSerializer {
    ...
    public static class DataWatcher<K> {
        ...
        public static final DataWatcherSerializer<EntityPose> POSE_SERIALIZER = DataWatcherRegistry.s;
