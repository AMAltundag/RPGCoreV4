...
public class StringRotationConstraint implements IEditorConstraint {
    ...
    public List<String> getInstruction() {
        ...
        instruction.add("Rotation");
        instruction.add("Three numbers: Euler Rotation");
        instruction.add("Four numbers: Quaternion Rotation");
        instruction.add("Separate numbers with space.");
        return instruction;
    }
