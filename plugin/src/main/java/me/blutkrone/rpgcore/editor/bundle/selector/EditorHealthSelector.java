...
import me.blutkrone.rpgcore.skill.selector.HealthSelector;
...
public class EditorHealthSelector extends AbstractEditorSelector {
    ...
    public AbstractCoreSelector build() {
        return new HealthSelector(this);
    }

    @Override
    public ItemStack getPreview() {
        return ItemBuilder.of(Material.BUCKET)
                .name("Health Selector")
                .build();
    }

    @Override
    public String getName() {
        return "Health Selector";
    }

    @Override
    public List<String> getInstruction() {
        List<String> instruction = new ArrayList<>();
        instruction.add("Health Selector");
