...
public class EditorMoveTrigger extends AbstractEditorTrigger {

    @EditorCategory(icon = Material.LEVER, info = "Trigger")
    @EditorBundle(name = "Distance")
    @EditorTooltip(tooltip = "How much distance to cover before going off")
    ...
    public AbstractCoreTrigger build() {
        return new CoreMoveTrigger(this);
    }
