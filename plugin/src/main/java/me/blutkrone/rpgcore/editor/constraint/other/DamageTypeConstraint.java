...
public class DamageTypeConstraint implements IEditorConstraint {
    ...
    public List<String> getHint(String value) {
        ...
        for (String type : manager.getDamageTypes().keySet()) {
    ...
    public boolean isDefined(String value) {
        DamageManager manager = RPGCore.inst().getDamageManager();
        return manager.getDamageTypes().containsKey(value);
    }
    ...
    public List<String> getInstruction() {
        ...
        instruction.add("Damage Type");
        instruction.add("Damage types process slightly differently from each other.");
        instruction.add("");
