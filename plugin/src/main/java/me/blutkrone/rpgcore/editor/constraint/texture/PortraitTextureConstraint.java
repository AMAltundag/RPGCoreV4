...
public class PortraitTextureConstraint implements IEditorConstraint {
    ...
    public List<String> getInstruction() {
        ...
        instruction.add("Portrait Texture");
        instruction.add("Texture used for portraits.");
        return instruction;
    }
