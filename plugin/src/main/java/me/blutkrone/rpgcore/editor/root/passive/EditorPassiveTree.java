...
import me.blutkrone.rpgcore.editor.constraint.texture.PortraitTextureConstraint;
...
public class EditorPassiveTree implements IEditorRoot<CorePassiveTree> {
    ...
    @EditorWrite(name = "Portrait", constraint = PortraitTextureConstraint.class)
    @EditorTooltip(tooltip = {"Portrait to use when viewed in menu."})
    public String job_portrait = "tree_nothing";
    @EditorWrite(name = "Category", constraint = StringConstraint.class)
