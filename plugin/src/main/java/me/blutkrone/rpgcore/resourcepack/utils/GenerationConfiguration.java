...
public class GenerationConfiguration {
     ...
     */
    public GenerationConfiguration(File file) {
    ...
    /*
     * Utility method to help with warning about a configuration that will
     * generate unnecessary strain on the player machine.
     *
     * @param message
     * @param showing
     */
