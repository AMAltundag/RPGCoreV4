...
public class OwnerNode implements IModelOwner {
    ...
    public OwnerNode(Location location, String model, String animation, double speed, int duration, double size) {
        ...
        if (bbmodel != null) {
            ...
            this.blockbench_model.forcePlay(animation, (float) speed);
        } else {
            try {
