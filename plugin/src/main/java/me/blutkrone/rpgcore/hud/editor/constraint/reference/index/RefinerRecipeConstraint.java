...
public class RefinerRecipeConstraint implements IEditorConstraint {

    @Override
    public List<String> getHint(String value) {
        value = value.toLowerCase();
        List<String> matched = new ArrayList<>();
        for (String id : RPGCore.inst().getItemManager().getRefineIndex().getKeys()) {
    ...
    public boolean isDefined(String value) {
        return RPGCore.inst().getItemManager().getRefineIndex().has(value);
    }

    @Override
    public void extend(String value) {
        RPGCore.inst().getItemManager().getRefineIndex().get(value);
    }
