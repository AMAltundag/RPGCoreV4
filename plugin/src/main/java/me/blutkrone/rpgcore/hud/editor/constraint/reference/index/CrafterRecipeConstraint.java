...
public class CrafterRecipeConstraint implements IEditorConstraint {

    @Override
    public List<String> getHint(String value) {
        value = value.toLowerCase();
        List<String> matched = new ArrayList<>();
        for (String id : RPGCore.inst().getItemManager().getCraftIndex().getKeys()) {
    ...
    public boolean isDefined(String value) {
        return RPGCore.inst().getItemManager().getCraftIndex().has(value);
    }

    @Override
    public void extend(String value) {
        RPGCore.inst().getItemManager().getCraftIndex().get(value);
    }
