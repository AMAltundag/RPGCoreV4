...
public class DialogueConstraint implements IEditorConstraint {

    @Override
    public List<String> getHint(String value) {
        value = value.toLowerCase();
        List<String> matched = new ArrayList<>();
        for (String key : RPGCore.inst().getQuestManager().getIndexDialogue().getKeys()) {
    ...
    public boolean isDefined(String value) {
        ...
        try {
            return RPGCore.inst().getQuestManager().getIndexDialogue().has(value);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public void extend(String value) {
        ...
        RPGCore.inst().getQuestManager().getIndexDialogue().get(value);
    }
