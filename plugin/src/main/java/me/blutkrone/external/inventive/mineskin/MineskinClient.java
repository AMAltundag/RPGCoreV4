package me.blutkrone.external.inventive.mineskin;

import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.google.gson.JsonParseException;
import com.google.gson.JsonParser;
import me.blutkrone.external.inventive.mineskin.data.MineskinException;
import me.blutkrone.external.inventive.mineskin.data.Skin;
import me.blutkrone.external.inventive.mineskin.data.SkinCallback;
...
public class MineskinClient {
    ...
    Skin handleResponse(String body) throws MineskinException, JsonParseException {
        ...
        this.nextRequest = System.currentTimeMillis() + ((long) ((skin.nextRequest + 20) * 1000L));
        return skin;
    }
